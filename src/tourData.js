export const tourData = [
  ...
  },
  {
    ...
    info:
      "London is famous for more than its magnificent ancient buildings, the Palace of Westminster, Trafalgar Square, Tower of London, London Eye, Art Galleries, and Big Ben. As the capital city of the United Kingdom of Great Britain and Northern Ireland, London is well known for influencing other cities of the world since the Middle Ages. London is the city of dreams.  When visitors stroll around London they get excited to find so many magnificent things. Some people just stand, stare, and start dreaming because London is a city of dreams that arouses feelings of joy and curiosity."
  },
  {
    id: 4,
    city: "tokyo",
